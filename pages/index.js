...
export default function Home() {
  ...
  useEffect(() => {
    ...
    console.log('[HikingLog] adminEmail env:', process.env.NEXT_PUBLIC_ADMIN_EMAIL)
    console.log('[HikingLog] user email:', user?.email)
    console.log('[HikingLog] isAdmin:', isAdmin)
